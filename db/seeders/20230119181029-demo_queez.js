...
module.exports = {
  async up(queryInterface) {
    ...
    const question = [
      ...
      {
        question:
          'В отечественном сериала «Интерны», в отличии от многих ситкомов, нет одного элемента. Основатели решили, что не смеют указывать зрителям. Что там отсутствует?',
        theme_id: 1,
        answer_id: 2,
      },
      {
      ...
      {
        question:
          'Что бросает на крышу Уолтер Уайт, азочарованный тем, что ему не удалось попасть в дом своей семьи с мирным подношением?',
        theme_id: 1,
        answer_id: 4,
      },
      {
        question: 'Сколько лет зрители ждали продолжения "Твин Пикс"?',
        theme_id: 1,
        answer_id: 5,
      },
      {
      ...
      {
        question:
          'Звуки спаривания каких животных были звуком общения велоцирапторов в «Парке Юрского периода»?',
        theme_id: 2,
        answer_id: 9,
      },
      {
      ...
      {
        question:
          'Какой комик появился в качестве зомби в «Добро пожаловать в Zомбилэнд»?',
        theme_id: 2,
        answer_id: 11,
      },
      {
